...
const navItems = [
  ...
  { label: "Notification Settings", href: "/admin/settings", icon: Bell },
];
...
export default function AdminLayout({
  ...
  // localStorage-persisted state isn't available during SSR/first paint. Zustand's persist
  // middleware rehydrates synchronously on store creation, before this first client render,
  // so it's safe to trust isAdminAuthenticated as soon as we know we're mounted on the client.
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          ...
          <div>
            ...
            <p className="font-sans text-xs text-brand-orange font-semibold">
              Admin Panel
            </p>
          </div>
          <button
      ...
      <div className="flex-1 md:ml-56 flex flex-col min-h-screen">
        ...
        <header className="bg-white border-b border-brand-warm-gray px-4 py-0 flex items-center gap-3 h-14 shrink-0">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <span className="font-sans text-xs text-brand-brown-mid hidden sm:block">
              Admin
            </span>
            <span className="font-sans text-xs text-brand-brown-mid hidden sm:block">
              /
